...
const string USER_HOST = "http://immense-garden-82747.herokuapp.com/api/users";
...
int sendConfigToServer(Data data, string id)
{
    ...
    if(curl) {
        /* First set the URL that is about to receive our POST. This URL can
           ...
           data. */
        string host = USER_HOST+id;
        curl_easy_setopt(curl, CURLOPT_URL, host.c_str());
        /* Now specify the POST data */
        sprintf(query, "data=%d_%d_%d_%d", d.illumination, d.humidity, d.temperature, d.soil_humidity);
